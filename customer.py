...
class Client:
    def __init__(self, first_name:str="Consumidor", last_name:str="Final", dni:str="9999999999")->None:
...
class RegularClient(Client):
    def __init__(self, first_name:str="Cliente", last_name:str="Final", dni:str="9999999999", card:bool=False)->None:
    ...
    def getJson(self)->Dict[str,Any]:
        # Método para imprimir los detalles del cliente minorista en la consola
        return {"dni":self.dni,"name":self.first_name,"last_name":self.last_name,"value": self.discount,"type":"regular","payment_method":self.payment_method}
...
class VipClient(Client):
    ...
    def getJson(self)->Dict[str,Any]:
        # Método para imprimir los detalles del cliente VIP en la consola
        return {"dni":self.dni,"name":self.first_name,"last_name":self.last_name,"value": self.limit,"type":"vip","payment_method":'credito'}
